...
/**
 * This is a template implementation of the PetService interface using an in-memory map.
 * It's kept as an example and is not part of the active codebase.
 */
@Service
public class PetServiceMapImpl implements PetService {

    private final Map<UUID, PetDTO> petDTOMap;
